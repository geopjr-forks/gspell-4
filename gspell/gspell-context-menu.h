...
G_GNUC_INTERNAL
GMenuItem *	_gspell_context_menu_get_language_menu_item	(const GspellLanguage            *current_language,
								 GspellLanguageActivatedCallback  callback,
								 gpointer                         user_data);

G_GNUC_INTERNAL
GMenuItem * _gspell_context_menu_get_suggestions_menu_item	(GspellChecker                     *checker,
